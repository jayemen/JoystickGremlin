...
class VJoy:
    ...
    def __init__(self, vjoy_id):
        ...
        if VJoyInterface.GetvJoyVersion() not in (0x218, 0x219):
            logging.getLogger("system").error(
                "Running incompatible vJoy version, 2.1.8 or 2.1.9 required"
            )
            raise VJoyError("Running incompatible vJoy version, 2.1.8 or 2.1.9 required")
